...
class User extends BaseController
{
    ...
    function endTask($taskId)
    {
            ...
            if ($result > 0) {
                 ...
                 $this->logrecord($process,$processFunction);
                 $this->session->set_flashdata('success', 'Mission successfully completed');
                ...
                $this->session->set_flashdata('error', 'Failed to complete the task');
                if ($this->role != ROLE_EMPLOYEE){
                    redirect('tasks');
                 }
                 else{
    ...
    function etasks()
    {
            ...
            $this->global['pageTitle'] = 'BSEU : All Missions';
