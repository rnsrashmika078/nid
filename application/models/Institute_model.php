...
class Institute_model extends CI_Model {
  ...
  function userListingCount($searchText = '',$instituteId=0)
    {
        $this->db->select('BaseTbl.id,BaseTbl.title,BaseTbl.first_name, BaseTbl.last_name,BaseTbl.address,BaseTbl.email,BaseTbl.mobile_number,BaseTbl.username,BaseTbl.password,Role.user_type,, BaseTbl.other_institute_name');
  ...
  /**
     ...
     */
    function userListing($searchText = '', $page=0, $segment=0,$instituteId=0)
    {
        $this->db->select('BaseTbl.id,I.name,BaseTbl.title,BaseTbl.first_name, BaseTbl.last_name,BaseTbl.address,BaseTbl.email,BaseTbl.mobile_number,BaseTbl.username,BaseTbl.password,Role.user_type, BaseTbl.other_institute_name');
        $this->db->from('users as BaseTbl');
        $this->db->join('user_types as Role', 'Role.user_type_id = BaseTbl.user_type_id','left');
		//$this->db->join('departments as Department','Department.department_id = BaseTbl.department_id', 'right');
  ...
  /**
     ...
     */
    function unactivatedUserCount($searchText = '',$instituteId=0)
    {
  ...
  /**
     ...
     * @return array $result : This is result
     */
    function unactivatedUser($searchText = '', $page=0, $segment=0, $instituteId=0)
    {
  ...
  /**
     ...
     * @return number $count : This is row count
     */
    function instrumentListingCount($searchText = '',$instituteId=0)
    {
  ...
  /**
     ...
     * @return array $result : This is result
     */
    function instrumentListing($searchText = '', $page=0, $segment=0,$instituteId=0)
    {
  ...
  function instituteListing($searchText = '', $page=0, $segment=0,$instituteId=0,$userTypeId=0)
    {

    $this->db->select('BaseTbl.institute_id,BaseTbl.name, BaseTbl.inst_coordinator,BaseTbl.latitude,BaseTbl.longitude, BaseTbl.address,BaseTbl.phone_number,BaseTbl.email,BaseTbl.description,BaseTbl.ministry');
        $this->db->from('institutes as BaseTbl');
   ...
   /**
     ...
     * @return number $count : This is row count
     */
    function facultyListingCount($searchText = '',$instituteId=0)
    {
...
/**
     ...
     * @return array $result : This is result
     */
    function facultyListing($searchText = '', $page=0, $segment=0,$instituteId=0)
    {
   ...
   /**
     ...
     * @return number $count : This is row count
     */
    function departmentListingCount($searchText = '',$instituteId=0)
    {
...
/**
     ...
     * @return array $result : This is result
     */
    function departmentListing($searchText = '', $page=0, $segment=0,$instituteId=0)
    {
        $this->db->select('BaseTbl.department_id,Institute.name,Faculty.faculty_name,BaseTbl.department_name, BaseTbl.address,BaseTbl.phone_number,BaseTbl.email,BaseTbl.abbreviation');
        $this->db->from('departments as BaseTbl');
     $this->db->join('institutes as Institute','Institute.institute_id = BaseTbl.institute_id');
  ...
  /**
     ...
     * @return number $count : This is row count
     */
    function laboratoryListingCount($searchText = '',$instituteId=0)
    {
        $this->db->select('*');
...
/**
     ...
     * @return array $result : This is result
     */
    function laboratoryListing($searchText = '', $page=0, $segment=0,$instituteId=0)
    {
...
/**
     ...
     * @return number $count : This is row count
     */
    function categoryListingCount($searchText = '',$instituteId=0)
    {
...
/**
     ...
     * @return array $result : This is result
     */
    function categoryListing($searchText = '', $page=0, $segment=0,$instituteId=0)
    {
...
function get_institute($instituteId)
  ...
  /**
	...
	//$this->db->where_not_in('user_type_id',5);
        return $query->result();
    }
	...
	function facultyCount($instituteId)
    {
        $this->db->select('*');
        $this->db->from('faculties as BaseTbl');
        $this->db->where('isDeleted', 0);
	...
	function departmentCount($instituteId)
    {
        $this->db->select('*');
        $this->db->from('departments as BaseTbl');
		$this->db->where('isDeleted', 0);
		...
		function laboratoryCount($instituteId)
    {
        $this->db->select('*');
        $this->db->from('laboratories as BaseTbl');
		$this->db->where('isDeleted', 0);
	...
	function usersCount($instituteId)
    {
        $this->db->select('*');
        $this->db->from('users as BaseTbl');
        $this->db->where('isDeleted', 0);
	...
	function instrumentCount($instituteId)
    {
        $this->db->select('*');
        $this->db->from('instrument as BaseTbl');
		$this->db->where('isDeleted', 0);
	...
	function registeredusersCount($instituteId)
    {
        $this->db->select('*');
        $this->db->from('users as BaseTbl');
        $this->db->where('isDeleted', 0);
