                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        <!--<div class="box-header">
                            <h3 class="box-title">Edit Faculty information</h3>
                        </div>-->
                        <!-- /.box-header -->
                        <!-- form start -->

                        <form role="form" action="<?php echo base_url() ?>editFaculty" method="post" id="editFaculty" role="form">
                            <div class="box-body">	
								...
								<div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="facultyName" placeholder="Faculty Name" name="facultyName" value="<?php echo $facultyName; ?>" maxlength="128">
                                            <input type="hidden" value="<?php echo $facultyId; ?>" name="facultyId" id="facultyId" />
                                        </div>
							...
							<!--<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
										...
										<input type="text" class="form-control" id="ministry" placeholder="Ministry" name="ministry" value="<?php echo $ministry; ?>" maxlength="300">                                       
                                    </div>
                                </div>                               
                            </div>-->
