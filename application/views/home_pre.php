...
.hero .right-tile, .hero .left-tile {
    /* height: 214px; */
    padding: 0px 0 50px;
    /* margin-bottom: 170px; */
    width: 100%;
    ...
    <nav class="navbar navbar-expand-lg navbar-light" style="height:80px;">
        ...
        <div class="collapse navbar-collapse pr-5" id="navbarSupportedContent">
            <ul class="navbar-nav ml-auto">
				...
				<!-- <li class="nav-item mx-3">
                    <a class="nav-link" href="homedashboard">Dashboard</a>
                </li>-->
            ...
            <div class="row">
                <div class="col-12">
                    <div class="reg-user-container">
                        Number of Registered Users: <?php if(isset($usersCount)) { echo $usersCount; } else { echo '0'; } ?>
                    </div>
                </div>
            </div>
    ...
    <footer class="footer_part" style="background: #070300 ; margin-top:-40px; ">
        <div class="container" style="margin-top:-70px; ">
            <div class="row justify-content-around">
              ...
              <li><p style="color: #FFFFFF;">Email  : idb@nsf.gov.lk</p></li>
