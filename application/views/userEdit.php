...
Old Password" id="oldpassword" name="oldpassword" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                            ...
                            <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="cpassword2">Confirm New Password</label>
                                        <input type="password" class="form-control required equalTo" placeholder="New Password Again" id="cpassword2" name="cpassword2" maxlength="20">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
