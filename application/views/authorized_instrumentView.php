      ...
      <div class="row" >
        <div class="col-lg-12">
          ...
          <table class="table table-borderless" style="  background-color:#FFFFFF" >
              ...
              <tbody>
                    <tr >
                        <td style="font-color:black; font-weight: 700;">Manufacturer</td>
                        <td><?php echo $manufacturer; ?></td>
                       
                        <td style="font-color:black; font-weight: 700;">Funding Source</td>
						<td><?php echo $FundingSource; ?></td>
                    </tr>
                    <tr>
                         <td style="font-color:black; font-weight: 700;">Model</td>
                        <td><?php echo $model; ?></td>
                        
                        <td style="font-color:black; font-weight: 700;">Whether the equipment service can be provided to external researchers/institutions</td>
                        <td><?php if ($externalResearch==1){echo 'Yes';} else {echo 'No';}?></td>
                    </tr>
                    <tr>
                        <td style="font-color:black; font-weight: 700;">Manufactured Year</td>
                        <td><?php echo $mYear; ?></td>
                        
                        <td style="font-color:black; font-weight: 700;">Availability of Technically Competent Staff</td>
                        <td><?php echo $staffName ; ?></td>
                    </tr>
                    <tr>
                        <td style="font-color:black; font-weight: 700;">HS Code</td>
                        <td><?php echo $accessories; ?></td>
                       				  
               
                        <td style="font-color:black; font-weight: 700;">Instrument Condition</td>
                        <td><?php echo $condition; ?></td>
                    </tr>
                    <tr>
                        <td style="font-color:black; font-weight: 700;">Vendor Name</td>
                      <td><?php echo $vendorName; ?></td>
                     
                        <td style="font-color:black; font-weight: 700;">Commencement of Operations Date</td>
                    ...
                    <tr>
                        <td style="font-color:black; font-weight: 700;">Vendor Contact</td>
                        <td><?php echo $vendorContact; ?></td>
                       
                        <td style="font-color:black; font-weight: 700;">InstrumentPrice</td>
                        <td><?php echo $price; ?></td>
                    </tr>
                    <tr>
                        <td style="font-color:black; font-weight: 700;">Vendor Url</td>
                         <td><?php echo $vendorUrl; ?></td>
                       <td style="font-color:black; font-weight: 700;">Stage of the Record</td>
                         <td><?php if ($recordStatus==1){echo 'Completed';} else {echo 'Incomplete';}?></td>
                       
                        
                    </tr>
                    <tr>
                        <td style="font-color:black; font-weight: 700;">Catalog Aceess</td>
                        <td><?php echo $catalogAccess; ?></td>
                       
                        <td style="font-color:black; font-weight: 700;"></td>
                        <td></td>
                    </tr>
                    <tr>
                        <td  style="font-color:black; font-weight: 700;">Catalog Upload</td>
                    ...
                    <tr>
                        <td style="font-color:black; font-weight: 700;">Catalog Link</td>
