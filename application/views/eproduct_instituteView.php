...
<body>
	...
	<div class="content-wrapper" style="margin-top:50px;">
      <section class="content-header">
         <h1>
             <i> <img src="<?php echo base_url(); ?>layout/img/box.svg" style=" margin-left:40px; " /> </i>Product Categories and contact information
			 <!--<a href="<?=base_url('eproduct_google'); ?>" class="button rounded-0 primary-bg text-white w-10 btn_1" style=" background-color:#EE9310; display:inline; margin-left:495px;" >View Product Categories in a Google Map </a>-->
                    </h1>
          ...
          <div class="box-body table-responsive no-padding">
            <?php
              ...
              <thead style="font-size:14px;">
                  <tr>
                   <th></th> 
                    <th>Product Category/ Test Name (Matrix) Information</th>
...
Institute: <?php echo $record->name ?>
</br>
Laboratory: <?php echo $record->laboratory_name ?>
</br>
 <?php if (!empty($record->accreditation_type)) { ?>
    <span style="background-color: #c8f7c5; padding: 3px; border-radius: 3px;">
        Accreditation Type: <?php echo $record->accreditation_type; ?>
    </span>
    <br>
<?php } ?>


Product Category: <?php echo $record->instrument_type ?>, <?php echo $record->keywords ?>
...
<p><a href="JavaScript:newPopup('<?php echo base_url().'eproduct_institute_googleview/'.$record->instrument_id; ?>');">View Location & Contact Information</a></p>
...
<?php
    ...
    '<h4>Lab Address: <?php echo $record->laboratory_address ?></h4>' +
     '<h4> Accreditation Type: <?php echo $record->accreditation_type ?></h4>' +    
