  ...
  <body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar" style="height:85px;">
      <div class="container-fluid px-md-4  ">
        <a class="navbar-brand" href="index.html" ><img src="layout/images/ban3.jpg" alt="nsf" ></a>

              <h1 class="mb-5" style=" padding-left: 400px; padding-top: 35px; color: #D7D7D8; font-size: 45px;">National Instrument Database</h1>
        ...
        <div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav ml-auto">
           <!-- <li class="nav-item active"><a href="http://localhost/instrument/index.php/Home" class="nav-link">Home</a></li>
            ...
            <li class="nav-item cta mr-md-1"><a href="home" class="nav-link" style="width:100px;" target="_blank">Home</a></li>
    ...
    <div class="hero-wrap img" style="background-image: url(<?=base_url(); ?>layout/images/bck1.jpg); height:550px;">
      <div class="overlay"></div>
      <div class="container">
        <div class="row d-md-flex no-gutters slider-text align-items-center justify-content-center" style="height:600px;">
                  ...
                  <div class="login-box-body">
                    ...
                    <?php
                      ...
                      <br>
                        ...
                        <!--Please give alidation rule to enter dashboard of particular user (based on his gmail id and user type)-->


                          <!--<a href="user_authentication"><img src="assets/images/google-btn.png" /></a>       -->
