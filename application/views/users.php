        ...
        <div class="row">
            ...
            ?>
                    <a class="btn btn-primary" href="<?php echo base_url(); ?>addNew" style="background-color: #EE9310; border-radius: 0px 3px 3px 0px; border: 2px solid #FFFFFF;">
                        <i class="fa fa-plus"></i>Add User</a> <?php  }  ?>
          ...
          <?php
            ...
            {
            ?>
           <a class="btn btn-primary" href="<?php echo base_url(); ?>unactivatedUser" style="background-color: #EE9310; border-radius: 0px 3px 3px 0px; border: 2px solid #FFFFFF;">
                        <i></i>Registered Users List</a>
       <?php
            }
            ?>
                </div>
          ...
          <div class="box-body table-responsive no-padding">
           ...
           if($role == ROLE_FACULTY_MANAGER )
            ...
            {  ?>
             ...
             if($role == ROLE_NSF_AUDIT || $role == ROLE_INSTITUTE_MANAGER || $role == ROLE_DIVISION_MANAGER|| $role == ROLE_FACULTY_MANAGER || $role == ROLE_ADMINISTRATIVE_INCHARGE || $role == ROLE_TECHNICAL_INCHARGE)
            {
            ?>
            ...
            if($role == ROLE_NSF_AUDIT || $role == ROLE_INSTITUTE_MANAGER || $role == ROLE_DIVISION_MANAGER|| $role == ROLE_FACULTY_MANAGER )
            {
            ?>			 
           ...
           if($role == ROLE_SUPER_ADMIN || $role == ROLE_ADMIN || $role == ROLE_NSF_AUDIT)
            ...
            ?>
                                ...
                                <th class="text-center">Logs/Edit/Delete</th><?php  } ?>
                            </tr>
                  </thead>
                  <tbody>
                            <?php
