...
<head>
  ...
  <title>aranoz</title>
  <link rel="icon" href="<?=base_url(); ?>layout/img/favicon.png">
  <!-- Bootstrap CSS -->
...
<body>
              ...
              <div class="col-lg-12">
                  <nav class="navbar navbar-expand-lg navbar-light">
                      ...
                      <div class="hearer_icon d-flex">
                             ...
                             <a href="http://idb.nsf.gov.lk"> <button type="submit" value="submit"  class="btn_3">
                                        Sign In
                                    </button>  </a>
   ...
   <!-- breadcrumb start-->
    ...
    <section class="banner_part">
                ...
                <div class="col-lg-12">
                    <div class="banner_slider owl-carousel">
                        <div class="single_banner_slider">
                            <div class="row">
                                <div class="col-lg-12 col-md-8" style="margin-top:-200px;margin-bottom:-300px; ">
                                    <div class="banner_text">
                                        <div class="banner_text_iner">
                                            <h1>National Instrument Database</h1>
                                            <h3>Identify and locate available instruments required for your research</h3>
                      ...
                      <!-- <div class="banner_img d-none d-lg-block" style="margin-top:-350px; margin-left:150px;">
       ...
       <!-- <div class="banner_img d-none d-lg-block" style="margin-left:800px;">
  ...
  <!--================Single Product Area =================-->
  <div class="product_image_area section_padding" style="margin-top:-100px; ">
    <div class="container">
      <div class="row s_product_inner justify-content-between">
        <div class="col-lg-7 col-xl-7">
          <div class="product_slider_img">
            <div id="vertical">
              <div data-thumb="<?=base_url(); ?>layout/img/product/single-product/product_1.png">
                <img src="<?=base_url(); ?>layout/img/product/single-product/product_1.png" />
              </div>
              <div data-thumb="<?=base_url(); ?>layout/img/product/single-product/product_1.png">
                <img src="<?=base_url(); ?>layout/img/product/single-product/product_1.png" />
              </div>
            ...
            <div class="col-lg-6">
              <div class="comment_list">
                ...
                <div class="review_item">
                  <div class="media">
                    <div class="d-flex">
                      <img src="<?=base_url(); ?>layout/img/product/single-product/review-3.png" alt="" />
                    </div>
                    <div class="media-body">
                      <h4>Blake Ruiz</h4>
                      <h5>12th Feb, 2017 at 05:56 pm</h5>
