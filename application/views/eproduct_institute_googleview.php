...
function initMap() {
    ...
    var markers = [
         ['<?php echo $instrumentId; ?>', <?php echo $latitude; ?>, <?php echo $longitude; ?>]
    ];
    ...
    '<h3><b> Accreditation Type: </b><?php echo $accreditationType; ?></h3>' +   
		'<p><b>Lab Address:</b><?php echo $laboratory_address; ?></p>' +
		 '<p><b>Product Category: </b><?php echo $instrumentType; ?></p>' + 
		  '<p><b>Contact: </b><?php echo $contactPersonName; ?></p>' + 
       
		'<p>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<?php echo $contactPersonEmail; ?></p>' +
		'<p>&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp;&nbsp; &nbsp; &nbsp;&nbsp; &nbsp;<?php echo $contactPersonPhoneNumber; ?>,&nbsp;<?php echo $contactPersonMobileNumber; ?> </p>' +
