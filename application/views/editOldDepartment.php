            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <div class="box box-primary">
                        ...
                        <form role="form" action="<?php echo base_url() ?>editDepartment" method="post" id="editDepartment" role="form">
                            <div class="box-body">	
								...
								<div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="departmentName" placeholder="Department Name" name="departmentName" value="<?php echo $departmentName; ?>" maxlength="128">
                                            <input type="hidden" value="<?php echo $departmentId; ?>" name="departmentId" id="departmentId" />
                                        </div>
							...
							<div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
										...
										<input type="text" class="form-control" id="abbreviation" placeholder="abbreviation" name="abbreviation" value="<?php echo $abbreviation; ?>" maxlength="300">                                       
                                    </div>
                                </div>                               
                            </div>	
